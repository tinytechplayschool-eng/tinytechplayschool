...
const activities = [
  { emoji: "🎨", name: "Art & Craft", color: "bg-soft-pink" },
  { emoji: "🎵", name: "Music & Dance", color: "bg-soft-purple" },
  { emoji: "📖", name: "Story Telling", color: "bg-soft-yellow" },
  { emoji: "⚽", name: "Outdoor Play", color: "bg-soft-green" },
  { emoji: "🧘", name: "Yoga", color: "bg-soft-blue" },
  { emoji: "🔤", name: "Phonics", color: "bg-soft-orange" },
  { emoji: "💡", name: "Creative Learning", color: "bg-soft-pink" },
  { emoji: "🎉", name: "Celebrations", color: "bg-soft-yellow" },
];
    ...
    <section className="bg-soft-green py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="text-foreground/70">A week at BrightSparks is packed with discovery, movement, music and imagination.</p>
        </div>
