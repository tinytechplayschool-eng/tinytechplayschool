...
import {
  Monitor, Gamepad2, Trees, BookOpen, Palette, ShieldCheck, Bus, Heart,
} from "lucide-react";
    ...
    <section className="bg-card py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <span className="inline-block px-3 py-1 rounded-full bg-brand-blue text-white text-xs font-bold mb-4">OUR FACILITIES</span>
          <h2 className="text-3xl md:text-4xl font-extrabold mb-3">Safe, bright spaces to grow in</h2>
          <p className="text-foreground/70">Every corner of our campus is designed with your child's safety, comfort and curiosity in mind.</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {facilities.map((f, i) => (
            ...
            >
              <div className={`mx-auto h-14 w-14 rounded-2xl grid place-items-center ${f.color} text-white mb-3`}>
